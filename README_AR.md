...
<img src="profile-circle.png" alt="عبدالسلام الأشول" width="150" />
...
<a href="https://abdulsalam-portfolio.vercel.app/ar" target="_blank">
...
<h3 dir="rtl">1. <a href="https://github.com/abdulsalamfaiz2024-cmd/financial-intelligence-agent">لوحة أبحاث وتحليلات السوق المالية</a></h3>
...
<h3 dir="rtl">2. <a href="https://github.com/abdulsalamfaiz2024-cmd/yemen-crisis-dashboard">مركز قيادة رصد وتحليل البيانات في اليمن</a></h3>
...
*   **خطوط نقل البيانات**: تقوم نصوص برمجية تعمل في الخلفية بجلب معاملات الطقس كل 5 دقائق من Open-Meteo API، ودمجها مع موجزات الأخبار الإنسانية من ReliefWeb ومؤشرات السكان العامة.
...
<h3 dir="rtl">3. <a href="https://github.com/abdulsalamfaiz2024-cmd/phonix-pro">PhonixPro — منصة تحليلات البيانات وإعداد التقارير</a></h3>
...
<h3 dir="rtl">4. <a href="https://github.com/abdulsalamfaiz2024-cmd/coms-standalone-core">COMS — النواة البرمجية المستقلة لإدارة الأعمال</a></h3>
...
<h3 dir="rtl">5. <a href="https://github.com/abdulsalamfaiz2024-cmd/mini-erp-system">Mini-ERP — نظام إدارة المبيعات والمخزون</a></h3>
...
<h3 dir="rtl">6. <a href="https://github.com/abdulsalamfaiz2024-cmd/podcast-text-extractor">مستخرج نصوص البودكاست — أنبوب معالجة النسخ الصوتي</a></h3>
...
<h3 dir="rtl">7. <a href="https://github.com/abdulsalamfaiz2024-cmd/pdf-pro-scanner">PDF Pro Scanner — تطبيق متعدد المنصات لأدوات المستندات</a></h3>
...
*   **تطبيق الجوال**: تطبيق جوال مبني بإطار Flutter مصمم لمسح المستندات وتنسيقها في مجلدات بلا اتصال مع دعم واجهات متعددة اللغات.
*   **التقنيات المستخدمة**: Flutter, React, Vite, TypeScript.

</div>

<h3 dir="rtl">8. <a href="https://github.com/abdulsalamfaiz2024-cmd/hotline-logistics-web">Hotline — بوابة الشحن والخدمات اللوجستية ثنائية اللغة</a></h3>
...
<h3 dir="rtl">9. <a href="https://github.com/abdulsalamfaiz2024-cmd/tnsc-database-schema">تصميم قاعدة البيانات المترابطة لشركة TNSC</a></h3>
...
*   **محلل ومهندس بيانات متدرب** لدى *مجموعة هائل سعيد أنعم (HSA)* — يناير 2026 حتى الآن
...
*   **مساعد رصد وتقييم** لدى *مؤسسة تمدين شباب* — يناير 2025 حتى ديسمبر 2025
    *   تطوير أطر الرصد الموجه نحو النتائج (ROM) وبرمجة نصوص مخصصة بلغة بايثون للتحقق من جودة وسلامة البيانات.
*   **محلل أعمال (دوام جزئي)** لدى *شركة تريبل نيكسوس الاستراتيجية (TNSC)* — يونيو 2024 حتى ديسمبر 2024
...
*   **برنامج إعداد القيادات الشابة** — مؤسسة تنمية القيادات الشابة (YLDF)
    <br/>*(يشمل: دبلوم اللغة الإنجليزية، دبلوم قيادة الحاسوب ICDL، ودبلوم القيادة والإلقاء أمام الجمهور)*
    <br/>
...
<div align="center">
  ...
  <p>إذا كنت تتطلع للتعاون في مشاريع هندسة البيانات، أو بناء لوحات تحكم ذكاء الأعمال، أو أتمتة العمليات اليدوية، يسعدني تواصلك معي</p>
